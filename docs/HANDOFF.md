...
> Last verified: 2026-07-23 (Wave 2 P1–P2 code cuts + CLI release automation residual; host stack unchanged for Wave 2 deploy)
> Branch: `main` (merged `feat/wave2-p1-p2-cuts`; CLI release automation already on main)
